...
final class Commands
{
    ...
    public const CODE_STYLE_FIX = 'php -d memory_limit=512M vendor/bin/php-cs-fixer fix --path-mode=intersection --config vendor/digitaldsdev/codestyle/.php_cs-fixer.php --allow-risky=yes';
    public const CODE_STYLE_CHECK = 'php -d memory_limit=512M vendor/bin/php-cs-fixer fix --path-mode=intersection --config vendor/digitaldsdev/codestyle/.php_cs-fixer.php --dry-run --allow-risky=yes';
